...
<form action="../public/index.php?action=create" method="post" onsubmit="return checkFormNewPost()">
<label><h2>Titre</h2><input type="text" name="title" id="myTitle"></label><br/>
<label id="post"><h2>Votre post</h2><textarea name="post" id="myPost" class="mceEditor" ></textarea></label><br />
