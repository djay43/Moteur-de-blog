           ...
           <aside id="comments">
                <h2>Commentaires</h2>
                    ...
                    <form action="index.php?action=new_comment&amp;id=<?= htmlspecialchars($post->getId()); ?>#comments" method="post" onsubmit="return checkFormComm()">
                              ...
                              <input type="text" id="author" name="author" class="form-control" id="usr" required maxlength="20"/><br/>

                              <h5>Commentaire</h5>
                              <textarea id="comment" name="comment" cols="20" rows="2" class="form-control" required maxlength="255"></textarea><br/><br/>
