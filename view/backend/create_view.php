...
<input name="send" type="submit" value="Envoyer" onclick="return(confirm('Êtes-vous sûr de vouloir poster cette article?'));" onclick="javascript:checkTextArea();" class="btn btn-success" /><br/></form>
